...
export default function Header({ onToggleSidebar }) {
  ...
  return (
    <header className="backdrop-blur-3xl border-b border-gray-800 px-4 sm:px-6 py-3 sm:py-4 z-50 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2 sm:space-x-4">
          ...
          <div className="relative hidden sm:block">
            ...
            <input
              ...
              className="border border-gray-800 rounded-[30px] pl-10 pr-4 py-2 text-sm text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent w-48 sm:w-64"
            />
          ...
          {showSearch && (
            <div className="absolute top-14 left-0 w-full px-4 sm:hidden z-50">
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Search here..."
                  autoFocus
                  className="border border-gray-800 rounded-[30px] pl-10 pr-4 py-2 w-full text-sm text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-black"
                />
              </div>
            </div>
          )}
          ...
          {/* Settings */}
          <button className="hidden sm:flex p-2 text-gray-400 hover:text-white hover:bg-gray-700 rounded-lg transition-colors">
            <svg
          ...
          <div className="w-8 h-8 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 flex items-center justify-center">
                <img
                    ...
                    alt="Profile"
                    className="w-10 h-8 rounded-full border border-gray-700"
/>
          </div>
        </div>
      </div>
