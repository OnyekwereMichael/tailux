...
//             <Search className="w-7 h-7 cursor-pointer hover:text-white" />
//             <Bell className="w-7 h-7 cursor-pointer hover:text-white" />
//             <HelpCircle className="w-7 h-7 cursor-pointer hover:text-white" />
//             <Settings className="w-7 h-7 cursor-pointer hover:text-white" />
//           </div>
//         </div>
